...
% +1/2 defect
p2 = plot(ps_x,ps_y,'o','MarkerFaceColor',p_color);hold on
p2.MarkerSize = 5;
p2.MarkerEdgeColor= 'none';
% -1/2 defect
p3 = plot(ns_x,ns_y,'o','MarkerFaceColor',n_color);hold on
p3.MarkerSize = 5;
...
q = quiver(Xu(1:step:end,1:step:end),Yu(1:step:end,1:step:end),...
    cos(Ang(1:step:end,1:step:end)),-sin(Ang(1:step:end,1:step:end)),.6);
q.LineWidth=1;
q.Color = [.4 .4 .4];
q.ShowArrowHead='off';
