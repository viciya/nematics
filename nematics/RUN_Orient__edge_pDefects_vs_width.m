...
%     Range  = find(width>Sw-dw & width<Sw+dw); % !!! REPLACED FOR FLIPPED FILES
...
%         filepathOP = filePathList{Range(i)};% !!! REPLACED FOR FLIPPED FILES
...
save([PC_path,'Curie\DESKTOP\HT1080\' 'pDdefect_150umEdge_Angle_new.mat'],'strANGLE');

%%
% PC_path = 'D:\GD\'; 
load([PC_path,'Curie\DESKTOP\HT1080\' 'pDdefect_150umEdge_Angle_RAW_DATA_FLIPPED_LR.mat'])
i= 2;
...
errorbar(width_ax, Left_av_angle,Left_std_angle,'o'); hold on
...
try
    [ps_xA, ~, plocPsi_vecA, ~, ~, ~] = fun_get_pn_Defects_newDefectAngle(Ang);
