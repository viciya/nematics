...
dw = 20; % Middle/Edge stripe width
i = 56;
...
res = .5;
figure
[edgePDF,edgeBIN] = histcounts(d_edgeAng_vec,[0:res:180],'Normalization','pdf'); 
polarplot(edgeBIN(2:end)*pi/180,edgePDF); hold on

[midPDF,midBIN] = histcounts(d_midAng_vec,[0:res:180],'Normalization','pdf'); 
polarplot(midBIN(2:end)*pi/180,midPDF); hold off

EXP = [midBIN(2:end)',midPDF',edgeBIN(2:end)',edgePDF'];
